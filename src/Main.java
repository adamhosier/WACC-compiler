...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(args.length == 0) {
            ...
            //System.setIn(new FileInputStream("/home/adam/labs/wacclab/examples/valid/pairs/readPair.wacc"));
            System.setIn(new FileInputStream("/Users/Dyl/Documents/workspace/WACC-compiler/examples/valid/while/whileBasic.wacc"));
