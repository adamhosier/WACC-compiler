...
public class WaccParser extends Parser {
	...
	public static final int
		INT_LIT=58, BOOL_LIT=29, NEW_PAIR=20, FST=22, WHILE=17, LESS_THAN_EQ=45, 
		STRING_LIT=63, MOD=38, CHARACTER_LIT=60, CHAR=26, DO=18, EQUALS=41, NOT=32, 
		AND=48, ORD=34, ESCAPED_CHAR_LIT=61, IF=13, GREATER_THAN_EQ=43, FREE=8, 
		CLOSE_PARENTHESES=51, THEN=14, COMMA=54, DONE=19, IS=5, PRINTLN=12, BEGIN=3, 
		RETURN=9, IDENT=57, PLUS=39, PAIR=28, EQ=46, COMMENT=1, EXIT=10, GREATER_THAN=42, 
		SND=23, NULL=56, ELSE=15, BOOL=25, SEMICOLON=55, INT=24, CHAR_LIT=62, 
		MULT=36, MINUS=40, TRUE=30, PRINT=11, CHR=35, NOT_EQ=47, FI=16, SKIP=6, 
		DIGIT_LIT=59, WS=2, OPEN_BRACKETS=52, READ=7, OR=49, LESS_THAN=44, OPEN_PARENTHESES=50, 
		LEN=33, CALL=21, DIV=37, END=4, CLOSE_BRACKETS=53, FALSE=31, STRING=27;
