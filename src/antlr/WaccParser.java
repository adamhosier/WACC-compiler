...
public class WaccParser extends Parser {
	...
	public static final int
		PRINT=11, DO=18, INT_LIT=58, CHR=35, MINUS=40, MULT=36, SEMICOLON=55, 
		GREATER_THAN=42, ELSE=15, IF=13, DONE=19, NOT_EQ=47, NULL=56, FST=22, 
		TRUE=30, IS=5, LESS_THAN=44, EQ=46, READ=7, NOT=32, AND=48, END=4, THEN=14, 
		EXIT=10, PLUS=39, CLOSE_PARENTHESES=51, ORD=34, CALL=21, FI=16, CHAR_LIT=62, 
		PRINTLN=12, NEW_PAIR=20, OPEN_PARENTHESES=50, OPEN_BRACKETS=52, SND=23, 
		CHAR=26, BEGIN=3, FREE=8, COMMENT=1, INT=24, RETURN=9, SKIP=6, WS=2, DIGIT_LIT=59, 
		COMMA=54, CHARACTER_LIT=60, MOD=38, OR=49, EQUALS=41, BOOL_LIT=29, GREATER_THAN_EQ=43, 
		DIV=37, STRING_LIT=63, LEN=33, IDENT=57, ESCAPED_CHAR_LIT=61, BOOL=25, 
		LESS_THAN_EQ=45, CLOSE_BRACKETS=53, STRING=27, WHILE=17, FALSE=31, PAIR=28;
	...
	public static final int
		...
		RULE_ifStat = 13, RULE_whileStat = 14, RULE_scopeStat = 15, RULE_ifStatSmall = 16, 
		RULE_assignLhs = 17, RULE_assignRhs = 18, RULE_newPair = 19, RULE_funcCall = 20, 
		RULE_argList = 21, RULE_pairElem = 22, RULE_type = 23, RULE_baseType = 24, 
		RULE_pairType = 25, RULE_pairElemType = 26, RULE_expr = 27, RULE_unaryOper = 28, 
		RULE_boolBinaryOper = 29, RULE_otherBinaryOper = 30, RULE_ident = 31, 
		RULE_arrayElem = 32, RULE_intSign = 33, RULE_character = 34, RULE_escapedChar = 35, 
		RULE_arrayLiter = 36, RULE_pairLiter = 37, RULE_comment = 38;
	public static final String[] ruleNames = {
		...
		"ifStat", "whileStat", "scopeStat", "ifStatSmall", "assignLhs", "assignRhs", 
		"newPair", "funcCall", "argList", "pairElem", "type", "baseType", "pairType", 
		"pairElemType", "expr", "unaryOper", "boolBinaryOper", "otherBinaryOper", 
	...
	public final FuncContext func() throws RecognitionException {
		...
		try {
			...
			setState(89); type(0);
			setState(90); ident();
			setState(91); match(OPEN_PARENTHESES);
			setState(93);
			_la = _input.LA(1);
			...
			setState(95); match(CLOSE_PARENTHESES);
	...
	private StatContext stat(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				{
				setState(114); varAssignment();
				}
				break;
			case 4:
				{
				setState(115); readStat();
				}
				break;
			case 5:
				{
				setState(116); freeStat();
				}
				break;
			case 6:
				{
				setState(117); returnStat();
				}
				break;
			case 7:
				{
				setState(118); exitStat();
				}
				break;
			case 8:
				{
				setState(119); printStat();
				}
				break;
			case 9:
				{
				setState(120); printlnStat();
				}
				break;
			case 10:
				{
			...
			case 11:
				{
				setState(122); whileStat();
				}
				break;
			case 12:
				{
				setState(123); scopeStat();
				}
				break;
			case 13:
				{
				setState(124); ifStatSmall();
				}
				break;
			}
	...
	public final IfStatSmallContext ifStatSmall() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_ifStatSmall);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final AssignLhsContext assignLhs() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(187); arrayElem();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(188); pairElem();
				}
				break;
			}
		}
	...
	public final AssignRhsContext assignRhs() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACKETS:
				enterOuterAlt(_localctx, 2);
				{
				setState(192); arrayLiter();
				}
				break;
			case NEW_PAIR:
				enterOuterAlt(_localctx, 3);
				{
				setState(193); newPair();
				}
				break;
			case FST:
			case SND:
				...
				{
				setState(194); pairElem();
				}
				break;
			case CALL:
				enterOuterAlt(_localctx, 5);
				{
				setState(195); funcCall();
				}
				break;
			default:
	...
	public final PairElemContext pairElem() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_pairElem);
		try {
			setState(225);
			switch (_input.LA(1)) {
			case FST:
	...
	private TypeContext type(int _p) throws RecognitionException {
		...
		try {
			...
			case STRING:
				{
				setState(228); baseType();
				}
				break;
			case PAIR:
				{
				setState(229); pairType();
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(232);
					if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
					setState(233); match(OPEN_BRACKETS);
					setState(234); match(CLOSE_BRACKETS);
					}
					} 
				}
				setState(239);
	...
	public final PairTypeContext pairType() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_pairType);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(242); match(PAIR);
			setState(243); match(OPEN_PARENTHESES);
			setState(244); pairElemType();
			setState(245); match(COMMA);
			setState(246); pairElemType();
	...
	public final PairElemTypeContext pairElemType() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_pairElemType);
		try {
			setState(255);
			...
			case 2:
				...
				setState(252); match(CLOSE_BRACKETS);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(254); match(PAIR);
				}
				break;
			}
		}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(258); unaryOper();
				setState(259); expr(4);
				}
				break;
			case 2:
				{
				setState(261); match(INT_LIT);
				}
				break;
			case 3:
				{
				setState(262); match(BOOL_LIT);
				}
				break;
			case 4:
				{
				setState(263); match(CHAR_LIT);
				}
				break;
			case 5:
				{
				setState(264); match(STRING_LIT);
				}
				break;
			case 6:
				{
				setState(265); pairLiter();
				}
				break;
			case 7:
				{
			...
			case 8:
				{
				setState(267); arrayElem();
				}
				break;
			case 9:
				{
				setState(268); match(OPEN_PARENTHESES);
				setState(269); expr(0);
				setState(270); match(CLOSE_PARENTHESES);
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
	...
	public final UnaryOperContext unaryOper() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_unaryOper);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BoolBinaryOperContext boolBinaryOper() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_boolBinaryOper);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OtherBinaryOperContext otherBinaryOper() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_otherBinaryOper);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ArrayElemContext arrayElem() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_arrayElem);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				case 1:
					...
					setState(297); expr(0);
					setState(298); match(CLOSE_BRACKETS);
					}
					}
					break;
				default:
	...
	public final IntSignContext intSign() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_intSign);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final CharacterContext character() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(306); match(CHARACTER_LIT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final EscapedCharContext escapedChar() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_escapedChar);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(308); match(ESCAPED_CHAR_LIT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArrayLiterContext arrayLiter() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(310); match(OPEN_BRACKETS);
			setState(319);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << BOOL_LIT) | (1L << NOT) | (1L << LEN) | (1L << ORD) | (1L << CHR) | (1L << MINUS) | (1L << OPEN_PARENTHESES) | (1L << NULL) | (1L << IDENT) | (1L << INT_LIT) | (1L << CHAR_LIT) | (1L << STRING_LIT))) != 0)) {
				{
			...
			setState(321); match(CLOSE_BRACKETS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"